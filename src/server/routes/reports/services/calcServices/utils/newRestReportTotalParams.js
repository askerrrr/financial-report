...
var calcRestReportTotalParams = (totals, prevSkuData, newSkuData, isCrossYearReport) => {
  if (isCrossYearReport) {
    var recalculatedTotalPreTaxProfitInCurrentYear =
      totals.totalPreTaxProfitInCurrentYear - prevSkuData.preTaxProfitInCurrentYear + newSkuData.preTaxProfitInCurrentYear;
    ...
    var recalculatedTotalFinalProfitInCurrentYear =
      totals.totalFinalProfitInCurrentYear - prevSkuData.finalProfitInCurrentYear + newSkuData.finalProfitInCurrentYear;
    ...
    var recalculatedTotalProductCostsInCurrentYear =
      ...
      prevSkuData.costPrice * prevSkuData.qtyInCurrentYear +
      newSkuData.costPrice * newSkuData.qtyInCurrentYear;
    ...
    var recalculatedTotalInsuranceFeeInCurrentYear =
      totals.totalInsuranceFeeInCurrentYear - prevSkuData.insuranceFeeInCurrentYear + newSkuData.insuranceFeeInCurrentYear;
    ...
    var recalculatedTotalOtherExpensesInCurrentYear =
      totals.totalOtherExpensesInCurrentYear - prevSkuData.otherExpensesInCurrentYear + newSkuData.otherExpensesInCurrentYear;
    ...
    var recalculatedTotalPreTaxProfitInNextYear =
      totals.totalPreTaxProfitInNextYear - prevSkuData.preTaxProfitInNextYear + newSkuData.preTaxProfitInNextYear;
    ...
    var recalculatedTotalFinalProfitInNextYear =
      totals.totalFinalProfitInNextYear - prevSkuData.finalProfitInNextYear + newSkuData.finalProfitInNextYear;
    ...
    var recalculatedTotalInsuranceFeeInNextYear =
      totals.totalInsuranceFeeInNextYear - prevSkuData.insuranceFeeInNextYear + newSkuData.insuranceFeeInNextYear;
    ...
    var recalculatedTotalOtherExpensesInNextYear =
      totals.totalOtherExpensesInNextYear - prevSkuData.otherExpensesInNextYear + newSkuData.otherExpensesInNextYear;
